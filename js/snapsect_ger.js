...
document.getElementById(obj).src = 'http://www.snapsects.com/img/'+arq.replaceAll(' ','_')+'.jpg';
...
function filtro() {
spopen('http://www.snapsects.com/snapsect_api.php','act=find&lang='+document.getElementById('language').value+'&antennae='+document.getElementById('lstantennae').value+'&mouthparts='+document.getElementById('lstmouthparts').value+'&wings='+document.getElementById('lstwings').value+'&legs='+document.getElementById('lstlegs').value+'&commonname='+document.getElementById('commonname').value+'&oorder='+document.getElementById('lstorder').value+'&lstnumlegs='+document.getElementById('lstnumlegs').value+'&classe='+document.getElementById('classe').value+'&family='+document.getElementById('family').value+'&lstother='+document.getElementById('lstother').value,'GET', function(res) {
