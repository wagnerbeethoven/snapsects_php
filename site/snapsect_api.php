...
// $t.='<td>No Picture</td>';
// }
$t.='<Td align="center"><a href="javascript:document.location.href='."'show_snapsect.php?id=".$tp->id."';".'">'.$tp->commonname.' ('.$tp->scientificname.')';
if (strlen($tp->photo) > 0) {
$t .= '<br><center><img src="'.$site_url.$tp->photo.'" alt="'.$tp->photodesc.'" width="240px" onload="redimensiona();" /></center>';
} // tem photo
$t.='</a></td>';
...
$t.='<Td align="center"><a href="javascript:document.location.href='."'show_snapsect.php?id=".$tp->id."';".'">'.$tp->commonname.' ('.$tp->scientificname.')';
if (strlen($tp->photo) > 0) {
$t .= '<br><center><img src="'.$site_url.$tp->photo.'" alt="'.$tp->photodesc.'" width="120px" onload="redimensiona();" /></center>';
} // tem photo
$t.='</a></td>';
$t.='<Td align="center">'.$tp->author.'</td>';
$t.='<Td align="center">'.$tp->colaborative.'</td>';
