...
require_once "scripts/diclib.php";
...
$texto = file_get_contents('school/'.$email.'/'.$sala.'/leituras/'.$id.'.txt');
} // existe arquivo...
return $texto;
} // da funcao...
...
$ga = 0;
$correcao = [];
if (!file_exists('school/'.$email.'/'.$sala.'/exerciceos/'.$id.'/'.$prova.'.ok')) { $quest = clearquest($quest); }
else {
$ga = 1;
