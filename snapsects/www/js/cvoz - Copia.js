...
case 'SUBMIT':
case 'BUTTON':
getvoiceconfirm(px.textContent+': , você deseja clicar?', function() {
px.click();
}, function() {
leobj(l, r+1);
}, function(res) {
...
case 'SUBMIT':
case 'BUTTON':
getvoiceconfirm(l[r].title+': , você deseja clicar?', function() {
px.click();
}, function() {
leobj(l, r+1);
}, function(res) {
...
fala(' acabou a tela...',startcommand);
} // ultrapassou...
} // da funcao...
...
l.push({ title: p[i].innerHTML, obj: p[i]});
}
