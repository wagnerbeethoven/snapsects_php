...
function myalert(texto, okfunc) {
navigator.notification.alert(texto,function() {
if (!okfunc) { } else { okfunc(); }
});
} // da funcao...

function myconfirm(titulo,texto,arrayopc,okfunc) {
navigator.notification.confirm(texto, function(resultado) {
okfunc(resultado);
},titulo,arrayopc);
} // da funcao...

function yesnoconfirm(titulo,texto,yesfunc,nofunc) {
myconfirm(titulo,texto,[dic[249],dic[248]], function(res) {
if (res == 1) { yesfunc(); }
if (res == 2) { if (!nofunc) { } else {nofunc(); } }
});
} // da funcao...
...
// MobileAccessibility.speak(t);
speak(t,o);
// if (!o) { } else { o(); }
} else {
if (!o) { } else { o(); }
} // nao fala mas o evento e executado...
} // da funcao.

function fala123(txt,okfunc) {
// if (device.platform == 'Android') {
MobileAccessibility.speak(txt);
if (!okfunc) { } else {okfunc(); }
// } else { fala8(txt,okfunc); }
} // da funcao
...
function spform(url, formulario, okfunc) {
...
xmlHttp.onreadystatechange = function (vv) {
if (xmlHttp.readyState == 4) {
if ((xmlHttp.status > 199) && (xmlHttp.status < 300)) {
if (!okfunc) { } else { okfunc(xmlHttp.responseText); }
} // sucesso...
} // tipo 4...
};
